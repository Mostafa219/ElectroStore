...
document.querySelector("#products-a").addEventListener("click", function () {
...
document.querySelector("#home-a").addEventListener("click", function () {
  window.open("../index.html", "_self");
});

document.querySelector("#about-a").addEventListener("click", function () {
